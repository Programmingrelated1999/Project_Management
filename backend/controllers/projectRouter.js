...
projectRouter.get("/:id", async (request, response) => {
  ...
  .populate('invites', {name: 1, username: 1}).populate('tasks', {name: 1, description: 1, createdDate: 1, assigned: 1})
  .populate('bugs', {name: 1, description: 1, createdDate: 1, assigned: 1});
